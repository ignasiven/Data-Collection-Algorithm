...
f_{23}= & \sum_{j}^{\Gamma}\left(\Bigg(1-\frac{\sum_{i}^{{\mathcal G}}p_{i}P_{i,j}}{\sqrt{\sum_{i}^{{\mathcal G}}p_{i}^{2}}\sqrt{\sum_{i}^{{\mathcal G}}P_{i,j}^{2}}}\Bigg)+\Bigg(1-\frac{\sum_{i}^{{\mathcal G}}q_{i}Q_{i,j}}{\sqrt{\sum_{i}^{{\mathcal G}}q_{i}^{2}}\sqrt{\sum_{i}^{{\mathcal G}}Q_{i,j}}}\Bigg)\right)\\
